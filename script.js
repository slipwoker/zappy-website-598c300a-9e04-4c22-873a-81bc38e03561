document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule, ruleValue) {
      const label =
        field.closest('.form-group, .field-wrapper, label')?.querySelector('label')?.textContent?.trim() ||
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '598c300a-9e04-4c22-873a-81bc38e03561',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '598c300a-9e04-4c22-873a-81bc38e03561';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '598c300a-9e04-4c22-873a-81bc38e03561';
